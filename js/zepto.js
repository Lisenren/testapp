...
define("js/zepto", [], function(require, exports) {
    (function(undefined) {
    ...
    (function($) {
        function detect(ua) {
            ...
            // Todos: clean this up with a better OS/browser seperation:
    ...
    (function($) {
        ...
        $.fn.trigger = function(event, data) {
            ...
            return this.each(function() {
                ...
                // (Todos: possibly support events on plain old objects)
    ...
    (function($) {
        ...
        $.ajax = function(options) {
            ...
            if (!arguments[1] && reqHost && reqHost != location.host) {
                ...
                return "璺ㄥ煙璇锋眰闇€瑕佸欢鏃跺垱寤篈JAX瀵硅薄,鏃犳硶瀹炴椂杩斿洖浠ｇ悊瀵硅薄";
            }
            ajaxStart(settings);
